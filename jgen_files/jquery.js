...
$(ksbs+" .KSS_btnBox #btnlistID li").css({listStyle:"none",float:"left",width:12,height:12,borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:1,fontSize:7,fontFamily:settings.btn.btn_fontFamily,lineHeight:"12px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
